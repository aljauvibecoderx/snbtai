...
import { ArrowLeft, CreditCard, Wallet, QrCode, Building2, Check, AlertCircle, Loader } from 'lucide-react';
...
export const AmbisCoinCheckout = ({ user }) => {
  ...
  const handleCheckout = async () => {
    ...
    setTimeout(() => {
      const orderId = 'AMB' + Date.now();
      navigate('/ambis-coin/payment', { 
        state: { 
          package: pkg, 
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl p-6 border border-gray-200 sticky top-6">
              ...
              <div className="mt-4 flex items-start gap-2 text-xs text-gray-500">
                ...
                <span>Pembayaran aman dan terenkripsi. Coin akan otomatis masuk setelah pembayaran berhasil.</span>
              </div>
            </div>
          </div>
        </div>
